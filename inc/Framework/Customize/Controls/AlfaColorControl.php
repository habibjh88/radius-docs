 ...
 */
class AlfaColorControl extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'radius-docs-custom-controls-css', radius_docs_get_assets('customize/css/customizer.css'), [ 'wp-color-picker' ], '1.0', 'all' );
		wp_enqueue_script(
			'radius-docs-custom-controls-js',
			radius_docs_get_assets('customize/js/customizer.js'),
