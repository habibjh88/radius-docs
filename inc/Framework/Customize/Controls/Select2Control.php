...
class Select2Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'radius-docs-custom-controls-js', radius_docs_get_assets('customize/js/customizer.js'), [ 'radius-docs-select2-js' ], '1.2', true );
		wp_enqueue_style( 'radius-docs-custom-controls-css', radius_docs_get_assets('customize/css/customizer.css'), [], '1.1', 'all' );
