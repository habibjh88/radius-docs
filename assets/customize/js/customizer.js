jQuery(document).ready(function ($) {
    ...
    */
    ...
    $('.radius-docs-background-attributes select').on('change', function () {
        console.log('changes')
        rtthemeBGAttributeTrigger($(this).closest('.radius-docs-background-attributes'));
    });

    function rtthemeBGAttributeTrigger($element) {
        var selectedVal = {
            position: $element.find('.radius-docs-bg-position').val(),
            attachment: $element.find('.radius-docs-bg-attachment').val(),
            repeat: $element.find('.radius-docs-bg-repeat').val(),
            size: $element.find('.radius-docs-bg-size').val(),
        };
