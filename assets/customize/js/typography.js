jQuery(document).ready(function ($) {
    ...
    $('.google-fonts-list').on('change', function () {
        ...
        var indexes = $.map(bodyfontcontrol.neuzinfontslist, function (obj, index) {
        ...
        $.each(bodyfontcontrol.neuzinfontslist[index].variants, function (val, text) {
        ...
        $(this).parent().parent().find('.google-fonts-category').val(bodyfontcontrol.neuzinfontslist[index].category);

        radiusDocsGetAllSelects($(this).closest('.google_fonts_select_control'));
    });
    ...
    function radiusDocsGetAllSelects($element) {
        var selectedFont = {
