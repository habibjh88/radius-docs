...
<article data-post-id="<?php the_ID(); ?>" <?php post_class( radius_docs_cpt_class( 'service' ) ); ?>>
	<div class="article-inner-wrapper">
		...
		<div class="entry-wrapper">
			...
			<?php
			if ( radius_docs_option( 'radius_docs_project_meta_visibility' ) ) {
				PostMeta::get_meta( 'radius-docs-project' );
			}

			if ( radius_docs_option( 'radius_docs_project_content_visibility' ) ) : ?>
			...
			if ( radius_docs_option( 'radius_docs_project_footer_visibility' ) ) {
				radius_docs_entry_footer( radius_docs_option( 'radius_docs_service_read_more' ) );
			}
			?>
		</div>
	</div>
